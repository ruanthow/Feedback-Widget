...
interface FeedbackSuccesseStepsProps{
    onHandleResetFeedbackSend: () => void
}

export function FeedbackSuccesseSteps({onHandleResetFeedbackSend}:FeedbackSuccesseStepsProps){
    ...
    return(
        <>
            ...
            <div className="flex flex-col items-center py-10 w-[304px]">
                ...
                onClick={onHandleResetFeedbackSend}
                >
                Quero enviar outro
                </button>
            </div>
